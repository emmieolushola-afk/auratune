...
const artists: Artist[] = [
  ...
  { id: "drakes-beat", name: "The Neighbourhood", genre: "Alt-pop", monthlyListeners: 22_000_000 },
  { id: "tame-impala", name: "Tame Impala", genre: "Psychedelic", monthlyListeners: 38_000_000 },
  { id: "million-faces", name: "Miguel", genre: "R&B", monthlyListeners: 31_000_000 },
  { id: "coldplay", name: "Coldplay", genre: "Alternative", monthlyListeners: 84_000_000 },
  { id: "alok", name: "Alok", genre: "Electronic", monthlyListeners: 47_000_000 },
];
...
const albums: Album[] = [
  ...
  { id: "the-neighbourhood", title: "I Love You.", artistId: "drakes-beat", artist: "The Neighbourhood", year: 2013, artwork: "from-gray-500/30 to-blue-500/30" },
  { id: "tame-currents", title: "Currents", artistId: "tame-impala", artist: "Tame Impala", year: 2015, artwork: "from-fuchsia-500/30 to-cyan-500/30" },
  { id: "miguel-wilder", title: "Wilder", artistId: "million-faces", artist: "Miguel", year: 2015, artwork: "from-purple-500/30 to-emerald-500/30" },
  { id: "coldplay-daily", title: "Everyday Life", artistId: "coldplay", artist: "Coldplay", year: 2019, artwork: "from-amber-500/30 to-rose-500/30" },
  { id: "alok-be-somebody", title: "Be Somebody", artistId: "alok", artist: "Alok", year: 2021, artwork: "from-cyan-500/30 to-violet-500/30" },
];
...
const songSeeds: SongSeed[] = [
  ...
  { id: "sweater-weather", title: "Sweater Weather", artistId: "drakes-beat", albumId: "the-neighbourhood", duration: 240, plays: 1_200_000_000, releasedAt: "2013-03-28", previewIndex: 11 },
  { id: "the-less-i-know", title: "The Less I Know the Better", artistId: "tame-impala", albumId: "tame-currents", duration: 271, plays: 900_000_000, releasedAt: "2015-07-17", previewIndex: 12 },
  { id: "let-it-happen", title: "Let It Happen", artistId: "tame-impala", albumId: "tame-currents", duration: 447, plays: 600_000_000, releasedAt: "2015-03-10", previewIndex: 13 },
  { id: "coffee", title: "Coffee", artistId: "million-faces", albumId: "miguel-wilder", duration: 240, plays: 400_000_000, releasedAt: "2015-05-01", previewIndex: 14 },
  { id: "sky-full-of-stars", title: "A Sky Full of Stars", artistId: "coldplay", albumId: "coldplay-daily", duration: 267, plays: 1_500_000_000, releasedAt: "2014-05-02", previewIndex: 15 },
  { id: "clocks", title: "Clocks", artistId: "coldplay", albumId: "coldplay-daily", duration: 283, plays: 1_000_000_000, releasedAt: "2003-03-10", previewIndex: 0 },
  { id: "pieces", title: "Pieces", artistId: "alok", albumId: "alok-be-somebody", duration: 200, plays: 350_000_000, releasedAt: "2021-04-16", previewIndex: 1 },
  { id: "get-lucky", title: "Get Lucky", artistId: "alok", albumId: "alok-be-somebody", duration: 239, plays: 600_000_000, releasedAt: "2021-06-11", previewIndex: 2 },
];
